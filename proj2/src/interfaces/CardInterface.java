...
public interface CardInterface extends Comparable {
   ...
   final public static String directory = "proj2/cards/";
   ...
   */
  // public Mainfile.Card( char suit, char rank, ImageIcon cardFace );
   ...
   * @param rank the rank value of this card
   */
 //  public Mainfile.Card(char suit,char rank);
  /**
...
//	public static int getRankIndex(char rank);
   ...
   * concatonated with the toString method of Mainfile.Card and ".gif"
   */
